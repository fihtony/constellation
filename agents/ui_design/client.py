"""Figma REST API client for the v2 UI Design boundary adapter.

Read-only, stdlib-only.  Rate limiting is respected via a configurable
minimum inter-call interval (default: 8 s, matching Figma's ~10 req/min
Tier-1 budget for Dev seats).
